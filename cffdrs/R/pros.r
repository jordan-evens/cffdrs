...
#' 
#' \code{pros} is used to calculate the rate of spread and
...
#' 
#' \code{pros} allows R users to calculate the rate of spread
...
#' degrees). \cr }
#' @return \code{pros} returns a dataframe which includes the
