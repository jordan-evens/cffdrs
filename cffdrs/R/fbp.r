...
#' not included in the system. This \code{fbp} function included these updates and
...
#' specified directly as an input, the \code{fbp} function will use this value
...
#' fbp(test_fbp[8:13,])	
#' #\code{fbp} function produces the default values if no data is fed to
#' #the function:
#' fbp()
#' 
#' @export fbp
