...
#' 
#' \code{ShelteredDuffMoistureCode} is used to calculate sheltered DMC (sDMC,
#' Wotton et al., 2005) based on daily noon weather observations of temperature,
#'relative humidity, 24-hour rainfall, and a previous day's calculated or
