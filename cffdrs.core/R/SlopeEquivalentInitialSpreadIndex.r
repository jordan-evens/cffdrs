.SlopeEquivalentInitialSpreadIndex.Fuel <- function(this, FFMC, BUI, WS, WAZ, GS, SAZ, FMC, SFC, PC, PDF, CC, CBH, ISI)
{
  ...
  RSZ <- .RateOfSpread(this, ISZ, BUI = NoBUI, FMC, SFC, PC, PDF, CC, CBH)
...
.SlopeEquivalentInitialSpreadIndex..FuelMixedwood <- function(this, FFMC, BUI, WS, WAZ, GS, SAZ, FMC, SFC, PC, PDF, CC, CBH, ISI)
{
  ...
  ISF_C2 <- .SlopeEquivalentInitialSpreadIndex(.C2, FFMC, BUI, WS, WAZ, GS, SAZ, FMC, SFC, PC, PDF, CC, CBH, ISI)
  ISF_D1 <- .SlopeEquivalentInitialSpreadIndex(.D1, FFMC, BUI, WS, WAZ, GS, SAZ, FMC, SFC, PC, PDF, CC, CBH, ISI)
